...
export default function AboutDescription(){
    return(
        <div className="flex flex-row justify-center items-center my-25 w-full max-w-full">
            <div className="w-[300px] md:w-[800px]">
                <SlideIn direction="down" delay={200}>
                    <h1 className="font-medium text-6xl md:text-7xl mb-10 mx-5">WE LAUNCH ROCKETS</h1>
                </SlideIn>
                <div className="flex flex-row m-5 gap-5 md:gap-10">
                ...
                <SlideIn direction="up" delay={200}>
                    <Image src="/team.png" width={800} height={150} alt="team image" className="mx-5"/>
                </SlideIn>
            </div>
        </div>
    )
